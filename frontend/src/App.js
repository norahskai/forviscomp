...
const App = () => {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        const response = await axios.get('https://visualize-and-comparisiontool.onrender.com/api/options');
  ...
  useEffect(() => {
    const fetchMaterials = async () => {
      if (selectedYear) {
        try {
          const response = await axios.get('https://visualize-and-comparisiontool.onrender.com/api/materials', {
  ...
  useEffect(() => {
    const fetchMonths = async () => {
      if (selectedYear && selectedMaterial) {
        try {
          const response = await axios.get('https://visualize-and-comparisiontool.onrender.com/api/months', {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://visualize-and-comparisiontool.onrender.com/api/data', {
        params: {
          year: selectedYear,
  ...
  const compareData = async () => {
    if (selectedMonth1 && selectedMonth2 && selectedYear) {
      try {
        const response = await axios.get('https://visualize-and-comparisiontool.onrender.com/api/compare', {
          params: {
            year: selectedYear,
